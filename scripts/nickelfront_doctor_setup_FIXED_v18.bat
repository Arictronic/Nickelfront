...
title Nickelfront Doctor + Setup FIXED v18

rem ============================================================================
rem Nickelfront Doctor + Setup
rem VERSION: 2026-05-22.18-BACKEND-RAG-INTERNAL-WAIT-NO-CLOSE
rem
...
rem
rem Использование:
rem   nickelfront_doctor_setup_FIXED_v18.bat               проверка + автоустановка + запуск сервисов + финальные тесты
rem   nickelfront_doctor_setup_FIXED_v18.bat --check-only  только проверка, ничего не ставить
rem   nickelfront_doctor_setup_FIXED_v18.bat --ask         спросить перед установкой
rem   nickelfront_doctor_setup_FIXED_v18.bat --no-start-app не запускать run_all/сервисы после setup
rem   nickelfront_doctor_setup_FIXED_v18.bat --force-install принудительно переустановить зависимости
rem   nickelfront_doctor_setup_FIXED_v18.bat --recreate-venv пересоздать virtualenv
rem ============================================================================

set "SCRIPT_VERSION=2026-05-22.18-BACKEND-RAG-INTERNAL-WAIT-NO-CLOSE"
set "SCRIPT_DIR=%~dp0"
